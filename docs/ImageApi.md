...
val inputStream : org.openapitools.client.infrastructure.OctetByteArray = BINARY_DATA_HERE // org.openapitools.client.infrastructure.OctetByteArray | A tar archive compressed with one of the following algorithms: identity (no compression), gzip, bzip2, xz.
try {
 ...
 **inputStream** | **org.openapitools.client.infrastructure.OctetByteArray**| A tar archive compressed with one of the following algorithms: identity (no compression), gzip, bzip2, xz. | [optional]
...
<a name="imageGet"></a>
# **imageGet**
> org.openapitools.client.infrastructure.OctetByteArray imageGet(name)
...
val name : kotlin.String = name_example // kotlin.String | Image name or ID
try {
    val result : org.openapitools.client.infrastructure.OctetByteArray = apiInstance.imageGet(name)
    println(result)
} catch (e: ClientException) {
...
# **imageGetAll**
> org.openapitools.client.infrastructure.OctetByteArray imageGetAll(names)
...
try {
    val result : org.openapitools.client.infrastructure.OctetByteArray = apiInstance.imageGetAll(names)
    println(result)
} catch (e: ClientException) {
...
val imagesTarball : org.openapitools.client.infrastructure.OctetByteArray = BINARY_DATA_HERE // org.openapitools.client.infrastructure.OctetByteArray | Tar archive containing images
try {
 ...
 **imagesTarball** | **org.openapitools.client.infrastructure.OctetByteArray**| Tar archive containing images | [optional]
