...
import org.openapitools.client.models.Secret
import org.openapitools.client.models.SecretSpec
...
class SecretApi(
    ...
    private class SecretListResponse(val value: List<Secret>) {
        @Serializer(SecretListResponse::class)
        companion object : KSerializer<SecretListResponse> {
            ...
            override fun serialize(encoder: Encoder, obj: SecretListResponse) = serializer.serialize(encoder, obj.value)
