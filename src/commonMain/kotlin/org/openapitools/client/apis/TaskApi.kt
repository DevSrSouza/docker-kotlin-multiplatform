...
class TaskApi(
    ...
    private class TaskListResponse(val value: List<Task>) {
        @Serializer(TaskListResponse::class)
        companion object : KSerializer<TaskListResponse> {
            private val serializer: KSerializer<List<Task>> = serializer<List<Task>>()
            override val descriptor = serializer.descriptor
            override fun serialize(encoder: Encoder, obj: TaskListResponse) = serializer.serialize(encoder, obj.value)
     ...
     */
    @Suppress("UNCHECKED_CAST")
    suspend fun taskLogs(id: kotlin.String, details: kotlin.Boolean?, follow: kotlin.Boolean?, stdout: kotlin.Boolean?, stderr: kotlin.Boolean?, since: kotlin.Int?, timestamps: kotlin.Boolean?, tail: kotlin.String?): HttpResponse<org.openapitools.client.infrastructure.OctetByteArray> {
