...
import org.openapitools.client.models.Config
import org.openapitools.client.models.ConfigSpec
...
class ConfigApi(
    ...
    private class ConfigListResponse(val value: List<Config>) {
        @Serializer(ConfigListResponse::class)
        companion object : KSerializer<ConfigListResponse> {
            ...
            override fun serialize(encoder: Encoder, obj: ConfigListResponse) = serializer.serialize(encoder, obj.value)
