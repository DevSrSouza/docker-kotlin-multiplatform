...
import org.openapitools.client.models.ContainerChangeResponseItem
import org.openapitools.client.models.ContainerConfig
import org.openapitools.client.models.ContainerCreateResponse
import org.openapitools.client.models.ContainerInspectResponse
import org.openapitools.client.models.ContainerPruneResponse
import org.openapitools.client.models.ContainerSummary
import org.openapitools.client.models.ContainerTopResponse
import org.openapitools.client.models.ContainerUpdateResponse
import org.openapitools.client.models.ContainerWaitResponse
...
class ContainerApi(
    ...
    private class ContainerChangesResponse(val value: List<ContainerChangeResponseItem>) {
        @Serializer(ContainerChangesResponse::class)
        companion object : KSerializer<ContainerChangesResponse> {
            ...
            override fun serialize(encoder: Encoder, obj: ContainerChangesResponse) = serializer.serialize(encoder, obj.value)
    ...
    private class ContainerListResponse(val value: List<ContainerSummary>) {
        @Serializer(ContainerListResponse::class)
        companion object : KSerializer<ContainerListResponse> {
            ...
            override val descriptor = serializer.descriptor
            override fun serialize(encoder: Encoder, obj: ContainerListResponse) = serializer.serialize(encoder, obj.value)
     ...
     */
    @Suppress("UNCHECKED_CAST")
    suspend fun containerLogs(id: kotlin.String, follow: kotlin.Boolean?, stdout: kotlin.Boolean?, stderr: kotlin.Boolean?, since: kotlin.Int?, until: kotlin.Int?, timestamps: kotlin.Boolean?, tail: kotlin.String?): HttpResponse<org.openapitools.client.infrastructure.OctetByteArray> {
     ...
     * @return void
     */
    suspend fun putContainerArchive(id: kotlin.String, path: kotlin.String, inputStream: org.openapitools.client.infrastructure.OctetByteArray, noOverwriteDirNonDir: kotlin.String?, copyUIDGID: kotlin.String?): HttpResponse<Unit> {
