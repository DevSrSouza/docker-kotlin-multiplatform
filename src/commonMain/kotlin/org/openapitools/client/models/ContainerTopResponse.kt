...
data class ContainerTopResponse (
    ...
    @SerialName(value = "Titles") val titles: kotlin.collections.List<kotlin.String>? = null,
    /* Each process running in the container, where each is process is an array of values corresponding to the titles.  */
    @SerialName(value = "Processes") val processes: kotlin.collections.List<kotlin.collections.List<kotlin.String>>? = null
)
