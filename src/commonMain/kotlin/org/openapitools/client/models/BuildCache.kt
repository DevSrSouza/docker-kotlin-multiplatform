...
data class BuildCache (
    ...
    @SerialName(value = "InUse") val inUse: kotlin.Boolean? = null,
    @SerialName(value = "Shared") val shared: kotlin.Boolean? = null,
    ...
    @SerialName(value = "LastUsedAt") val lastUsedAt: kotlin.String? = null,
    @SerialName(value = "UsageCount") val usageCount: kotlin.Int? = null
)
