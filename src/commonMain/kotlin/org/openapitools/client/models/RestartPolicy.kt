...
data class RestartPolicy (
    ...
    @SerialName(value = "Name") val name: RestartPolicy.Name? = null,
    /* If `on-failure` is used, the number of times to retry before giving up.  */
    @SerialName(value = "MaximumRetryCount") val maximumRetryCount: kotlin.Int? = null
) {
    ...
    enum class Name(val value: kotlin.String) {
        ...
        @SerialName(value = "unless-stopped") unlessMinusStopped("unless-stopped"),
        @SerialName(value = "on-failure") onMinusFailure("on-failure");
    }
}
