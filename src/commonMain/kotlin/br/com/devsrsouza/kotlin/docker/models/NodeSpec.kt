...
data class NodeSpec (
    ...
    /* Role of the node. */
    @SerialName(value = "Role") val role: NodeSpec.Role? = null,
    /* Availability of the node. */
    @SerialName(value = "Availability") val availability: NodeSpec.Availability? = null
) {
    ...
    enum class Role(val value: kotlin.String) {
        @SerialName(value = "worker") worker("worker"),
    ...
    enum class Availability(val value: kotlin.String) {
        ...
        @SerialName(value = "drain") drain("drain");
    }
}
