...
data class MountBindOptions (
    ...
    @SerialName(value = "Propagation") val propagation: MountBindOptions.Propagation? = null,
    ...
    enum class Propagation(val value: kotlin.String) {
        ...
        @SerialName(value = "rprivate") rprivate("rprivate"),
        @SerialName(value = "shared") shared("shared"),
        @SerialName(value = "rshared") rshared("rshared"),
        @SerialName(value = "slave") slave("slave"),
        @SerialName(value = "rslave") rslave("rslave");
    }
}
