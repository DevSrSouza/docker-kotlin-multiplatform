...
data class EndpointPortConfig (
    ...
    @SerialName(value = "Protocol") val protocol: EndpointPortConfig.Protocol? = null,
    /* The port inside the container. */
    @SerialName(value = "TargetPort") val targetPort: kotlin.Int? = null,
    /* The port on the swarm hosts. */
    @SerialName(value = "PublishedPort") val publishedPort: kotlin.Int? = null,
    ...
    @SerialName(value = "PublishMode") val publishMode: EndpointPortConfig.PublishMode? = null
) {
    ...
    enum class Protocol(val value: kotlin.String) {
        @SerialName(value = "tcp") tcp("tcp"),
        @SerialName(value = "udp") udp("udp"),
        @SerialName(value = "sctp") sctp("sctp");
    }
    /**
     * The mode in which port is published.  <p><br /></p>  - \"ingress\" makes the target port accessible on every node,   regardless of whether there is a task for the service running on   that node or not. - \"host\" bypasses the routing mesh and publish the port directly on   the swarm node where that service is running. 
     * Values: ingress,host
    ...
    enum class PublishMode(val value: kotlin.String) {
        @SerialName(value = "ingress") ingress("ingress"),
