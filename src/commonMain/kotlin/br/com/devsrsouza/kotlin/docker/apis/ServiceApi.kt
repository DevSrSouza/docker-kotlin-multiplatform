...
import br.com.devsrsouza.kotlin.docker.models.Service
import br.com.devsrsouza.kotlin.docker.models.ServiceCreateResponse
import br.com.devsrsouza.kotlin.docker.models.ServiceSpec
import br.com.devsrsouza.kotlin.docker.models.ServiceUpdateResponse
...
class ServiceApi(
    ...
    suspend fun serviceList(filters: kotlin.String?, status: kotlin.Boolean?): HttpResponse<kotlin.collections.List<Service>> {
        ...
        return request(
            ...
            localVariableBody,
            localVariableAuthNames
        ).wrap<br.com.devsrsouza.kotlin.docker.apis.ServiceApi.ServiceListResponse>().map { value }
    }

    @Serializable
    private class ServiceListResponse(val value: List<Service>) {
        @Serializer(br.com.devsrsouza.kotlin.docker.apis.ServiceApi.ServiceListResponse::class)
        companion object : KSerializer<br.com.devsrsouza.kotlin.docker.apis.ServiceApi.ServiceListResponse> {
            private val serializer: KSerializer<List<Service>> = serializer<List<Service>>()
            override val descriptor = br.com.devsrsouza.kotlin.docker.apis.ServiceApi.ServiceListResponse.Companion.serializer.descriptor
            override fun serialize(encoder: Encoder, obj: br.com.devsrsouza.kotlin.docker.apis.ServiceApi.ServiceListResponse) = br.com.devsrsouza.kotlin.docker.apis.ServiceApi.ServiceListResponse.Companion.serializer.serialize(encoder, obj.value)
            override fun deserialize(decoder: Decoder) =
                br.com.devsrsouza.kotlin.docker.apis.ServiceApi.ServiceListResponse(
                    br.com.devsrsouza.kotlin.docker.apis.ServiceApi.ServiceListResponse.Companion.serializer.deserialize(
                        decoder
                    )
                )
        }
     ...
     */
    @Suppress("UNCHECKED_CAST")
    suspend fun serviceLogs(id: kotlin.String, details: kotlin.Boolean?, follow: kotlin.Boolean?, stdout: kotlin.Boolean?, stderr: kotlin.Boolean?, since: kotlin.Int?, timestamps: kotlin.Boolean?, tail: kotlin.String?): HttpResponse<br.com.devsrsouza.kotlin.docker.infrastructure.OctetByteArray> {
