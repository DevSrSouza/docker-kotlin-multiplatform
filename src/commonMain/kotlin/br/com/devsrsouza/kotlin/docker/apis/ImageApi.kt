...
import br.com.devsrsouza.kotlin.docker.models.BuildPruneResponse
import br.com.devsrsouza.kotlin.docker.models.ContainerConfig
import br.com.devsrsouza.kotlin.docker.models.ErrorResponse
import br.com.devsrsouza.kotlin.docker.models.HistoryResponseItem
import br.com.devsrsouza.kotlin.docker.models.IdResponse
import br.com.devsrsouza.kotlin.docker.models.Image
import br.com.devsrsouza.kotlin.docker.models.ImageDeleteResponseItem
import br.com.devsrsouza.kotlin.docker.models.ImagePruneResponse
import br.com.devsrsouza.kotlin.docker.models.ImageSearchResponseItem
import br.com.devsrsouza.kotlin.docker.models.ImageSummary
...
class ImageApi(
    ...
    suspend fun imageDelete(name: kotlin.String, force: kotlin.Boolean?, noprune: kotlin.Boolean?): HttpResponse<kotlin.collections.List<ImageDeleteResponseItem>> {
        ...
        return request(
            ...
            localVariableBody,
            localVariableAuthNames
        ).wrap<br.com.devsrsouza.kotlin.docker.apis.ImageApi.ImageDeleteResponse>().map { value }
    }

    @Serializable
    private class ImageDeleteResponse(val value: List<ImageDeleteResponseItem>) {
        @Serializer(br.com.devsrsouza.kotlin.docker.apis.ImageApi.ImageDeleteResponse::class)
        companion object : KSerializer<br.com.devsrsouza.kotlin.docker.apis.ImageApi.ImageDeleteResponse> {
            private val serializer: KSerializer<List<ImageDeleteResponseItem>> = serializer<List<ImageDeleteResponseItem>>()
            override val descriptor = br.com.devsrsouza.kotlin.docker.apis.ImageApi.ImageDeleteResponse.Companion.serializer.descriptor
            override fun serialize(encoder: Encoder, obj: br.com.devsrsouza.kotlin.docker.apis.ImageApi.ImageDeleteResponse) = br.com.devsrsouza.kotlin.docker.apis.ImageApi.ImageDeleteResponse.Companion.serializer.serialize(encoder, obj.value)
            override fun deserialize(decoder: Decoder) =
                br.com.devsrsouza.kotlin.docker.apis.ImageApi.ImageDeleteResponse(
                    br.com.devsrsouza.kotlin.docker.apis.ImageApi.ImageDeleteResponse.Companion.serializer.deserialize(
                        decoder
                    )
                )
        }
     ...
     */
    @Suppress("UNCHECKED_CAST")
    suspend fun imageGet(name: kotlin.String): HttpResponse<br.com.devsrsouza.kotlin.docker.infrastructure.OctetByteArray> {
     ...
     */
    @Suppress("UNCHECKED_CAST")
    suspend fun imageGetAll(names: kotlin.collections.List<kotlin.String>?): HttpResponse<br.com.devsrsouza.kotlin.docker.infrastructure.OctetByteArray> {
    ...
    suspend fun imageHistory(name: kotlin.String): HttpResponse<kotlin.collections.List<HistoryResponseItem>> {
        ...
        return request(
            ...
            localVariableBody,
            localVariableAuthNames
        ).wrap<br.com.devsrsouza.kotlin.docker.apis.ImageApi.ImageHistoryResponse>().map { value }
    }

    @Serializable
    private class ImageHistoryResponse(val value: List<HistoryResponseItem>) {
        @Serializer(br.com.devsrsouza.kotlin.docker.apis.ImageApi.ImageHistoryResponse::class)
        companion object : KSerializer<br.com.devsrsouza.kotlin.docker.apis.ImageApi.ImageHistoryResponse> {
            private val serializer: KSerializer<List<HistoryResponseItem>> = serializer<List<HistoryResponseItem>>()
            override val descriptor = br.com.devsrsouza.kotlin.docker.apis.ImageApi.ImageHistoryResponse.Companion.serializer.descriptor
            override fun serialize(encoder: Encoder, obj: br.com.devsrsouza.kotlin.docker.apis.ImageApi.ImageHistoryResponse) = br.com.devsrsouza.kotlin.docker.apis.ImageApi.ImageHistoryResponse.Companion.serializer.serialize(encoder, obj.value)
            override fun deserialize(decoder: Decoder) =
                br.com.devsrsouza.kotlin.docker.apis.ImageApi.ImageHistoryResponse(
                    br.com.devsrsouza.kotlin.docker.apis.ImageApi.ImageHistoryResponse.Companion.serializer.deserialize(
                        decoder
                    )
                )
        }
    ...
    suspend fun imageList(all: kotlin.Boolean?, filters: kotlin.String?, digests: kotlin.Boolean?): HttpResponse<kotlin.collections.List<ImageSummary>> {
        ...
        return request(
            ...
            localVariableBody,
            localVariableAuthNames
        ).wrap<br.com.devsrsouza.kotlin.docker.apis.ImageApi.ImageListResponse>().map { value }
    }

    @Serializable
    private class ImageListResponse(val value: List<ImageSummary>) {
        @Serializer(br.com.devsrsouza.kotlin.docker.apis.ImageApi.ImageListResponse::class)
        companion object : KSerializer<br.com.devsrsouza.kotlin.docker.apis.ImageApi.ImageListResponse> {
            private val serializer: KSerializer<List<ImageSummary>> = serializer<List<ImageSummary>>()
            override val descriptor = br.com.devsrsouza.kotlin.docker.apis.ImageApi.ImageListResponse.Companion.serializer.descriptor
            override fun serialize(encoder: Encoder, obj: br.com.devsrsouza.kotlin.docker.apis.ImageApi.ImageListResponse) = br.com.devsrsouza.kotlin.docker.apis.ImageApi.ImageListResponse.Companion.serializer.serialize(encoder, obj.value)
            override fun deserialize(decoder: Decoder) =
                br.com.devsrsouza.kotlin.docker.apis.ImageApi.ImageListResponse(
                    br.com.devsrsouza.kotlin.docker.apis.ImageApi.ImageListResponse.Companion.serializer.deserialize(
                        decoder
                    )
                )
        }
     ...
     * @return void
     */
    suspend fun imageLoad(quiet: kotlin.Boolean?, imagesTarball: br.com.devsrsouza.kotlin.docker.infrastructure.OctetByteArray?): HttpResponse<Unit> {
    ...
    suspend fun imageSearch(term: kotlin.String, limit: kotlin.Int?, filters: kotlin.String?): HttpResponse<kotlin.collections.List<ImageSearchResponseItem>> {
        ...
        return request(
            ...
            localVariableBody,
            localVariableAuthNames
        ).wrap<br.com.devsrsouza.kotlin.docker.apis.ImageApi.ImageSearchResponse>().map { value }
    }

    @Serializable
    private class ImageSearchResponse(val value: List<ImageSearchResponseItem>) {
        @Serializer(br.com.devsrsouza.kotlin.docker.apis.ImageApi.ImageSearchResponse::class)
        companion object : KSerializer<br.com.devsrsouza.kotlin.docker.apis.ImageApi.ImageSearchResponse> {
            private val serializer: KSerializer<List<ImageSearchResponseItem>> = serializer<List<ImageSearchResponseItem>>()
            override val descriptor = br.com.devsrsouza.kotlin.docker.apis.ImageApi.ImageSearchResponse.Companion.serializer.descriptor
            override fun serialize(encoder: Encoder, obj: br.com.devsrsouza.kotlin.docker.apis.ImageApi.ImageSearchResponse) = br.com.devsrsouza.kotlin.docker.apis.ImageApi.ImageSearchResponse.Companion.serializer.serialize(encoder, obj.value)
            override fun deserialize(decoder: Decoder) =
                br.com.devsrsouza.kotlin.docker.apis.ImageApi.ImageSearchResponse(
                    br.com.devsrsouza.kotlin.docker.apis.ImageApi.ImageSearchResponse.Companion.serializer.deserialize(
                        decoder
                    )
                )
        }
